...
> [`server-esp32-spiram`](../server-esp32-spiram/README.md) (PSRAM) target instead.
...
`xtensa-esp32-elf-addr2line -e target/xtensa-esp32-espidf/release/server-esp32-no-spiram <pc>…`.
